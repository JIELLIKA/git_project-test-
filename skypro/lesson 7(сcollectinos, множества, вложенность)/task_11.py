...
Филолог-журналист по образованию. За плечами более 9 лет экскурсий по Грузии и барменский опыт.
Писатель. Перфекционист. И просто увлеченный человек. Родился и вырос в Тбилиси.
Более 10 поколений тут. Люблю этот райский уголок на планете и свою работу.
Мама-кулинар привила любовь к вкусной еде."""
...
user_input_pk = int(input("Введите pk:"))

for i in range(len(guides)):
    if guides[i]["pk"] == user_input_pk:
        print(f"{guides[i]['fields']['full_name']}, туров {guides[i]['fields']['tours_count']}")
        print(guides[i]['fields']['bio'])